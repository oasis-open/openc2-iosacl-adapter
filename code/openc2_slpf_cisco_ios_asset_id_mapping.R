#The asset_id_mapping() function extracts the asset_id from an OpenC2 command and searches all the network-connection-relevant information in the configuration file. It extracts all the information needed for connecting to an actuator
